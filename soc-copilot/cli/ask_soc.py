#!/usr/bin/env python3
"""
RansomEye SOC Copilot - Ask SOC CLI
AUTHORITATIVE: Command-line tool for querying SOC copilot
"""
...
from api.copilot_api import CopilotAPI, CopilotAPIError


def main():
    """Main CLI entry point."""
    parser = argparse.ArgumentParser(
        description='Query SOC copilot'
    )
    parser.add_argument(
        '--query',
        required=True,
